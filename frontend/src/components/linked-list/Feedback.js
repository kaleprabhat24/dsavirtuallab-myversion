...
const LinkedListFeedback = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:5000/linkedlist_feedback', {
                method: 'POST',
                headers: {
    ...
    return (
        <div style={styles.container}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    Did you understand the core concepts of Linked Lists?
                    <textarea
                        name="understanding"
...
export default LinkedListFeedback;
