...
const questions = [
  {
    ...
    description: "Write a function to perform insertion sort on an array. Insertion sort is a simple sorting algorithm that builds the final sorted array one item at a time. It is much less efficient on large lists compared to more advanced algorithms such as quicksort.",
    difficulty: "Easy",
    examples: [
      "Input: [12, 11, 13, 5, 6]\nOutput: [5, 6, 11, 12, 13]",
    ],
...
export default function SortPracticePlatform() {
