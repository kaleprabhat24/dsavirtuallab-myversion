...
const HashingFeedback = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:5000/hashing_feedback', {
                method: 'POST',
                headers: {
    ...
    return (
        <div style={styles.container}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    Did you understand the core concepts of hashing?
                    <textarea
                        name="understanding"
...
export default HashingFeedback;
